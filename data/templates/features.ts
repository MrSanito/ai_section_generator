      ...
      children: [
        {
          ...
          type: 'card',
          tag: 'div',
          className: 'p-5 sm:p-6 rounded-2xl bg-white dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 shadow-xs hover:shadow-md hover:border-orange-300 dark:hover:border-neutral-600 transition-all group flex flex-col justify-start',
          children: [
            {
              id: 'feat-icon-1',
              type: 'badge',
              tag: 'span',
              content: '⚡',
              className: 'w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/40 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4 group-hover:scale-110 transition-transform',
            },
            {
              id: 'feat-title-1',
              type: 'heading',
              ...
              className: 'text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1.5 sm:mb-2',
            },
            {
              id: 'feat-desc-1',
              type: 'paragraph',
              ...
              className: 'text-xs sm:text-sm text-slate-600 dark:text-neutral-300 leading-relaxed',
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              tag: 'span',
              content: '🌳',
              className: 'w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800/40 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4 group-hover:scale-110 transition-transform',
            },
            {
              id: 'feat-title-2',
              type: 'heading',
          ...
          children: [
            {
              ...
              tag: 'span',
              content: '✏️',
              className: 'w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800/40 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4 group-hover:scale-110 transition-transform',
            },
            {
              id: 'feat-title-3',
              type: 'heading',
          ...
          children: [
            {
              ...
              tag: 'span',
              content: '💾',
              className: 'w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/40 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4 group-hover:scale-110 transition-transform',
            },
            {
              id: 'feat-title-4',
              type: 'heading',
